...
在java API设计中有着许多的各种规则「[只要一个返回语句](https://justjavac.com/java/2012/05/18/a-return-to-good-code.html)」、「[关于返回 Null 值的问题](https://justjavac.com/java/2012/05/18/returning-null.html)」 与折衷考量，和其他所有复杂任务一样，它考验着我们的记忆力及脑力.
